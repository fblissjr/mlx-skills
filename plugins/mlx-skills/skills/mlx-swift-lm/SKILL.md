...
name: mlx-swift-lm
description: >-
  Run LLMs and VLMs on Apple silicon in Swift with mlx-swift-lm. Use when
  doing local inference, streaming generation, tool calling, LoRA/DoRA
  fine-tuning, embeddings, or model porting inside a Swift, iOS, or macOS
  app. NOT the Python mlx-lm/mlx-vlm libraries (use the mlx-models skill) and
  NOT core Swift MLX array or nn code (use the mlx-swift skill). Triggers on
  "import MLXLLM", "import MLXVLM", "import MLXLMCommon", "import
  MLXEmbedders", "ChatSession", "ModelContainer", "LLMModelFactory",
  "VLMModelFactory", "GenerateParameters", "wired memory", "mlx-swift-lm",
  "local LLM swift", "VLM swift", "LoRA training swift", "tool calling swift".
  Covers model loading, ChatSession, streaming generation, KV cache, tool
  calling, wired-memory coordination, LoRA/DoRA fine-tuning, embeddings, and
  porting models from Python MLX-LM to Swift.
  Invoke with /mlx-skills:mlx-swift-lm.
license: MIT
compatibility: "Requires macOS/iOS with Apple silicon (M1+) and Swift 5.9+ / Xcode 15+"
...
> **Related skills:** For core Swift MLX (arrays, nn, optimizers, custom
> kernels), load the `mlx-swift` skill. For the Python mlx-lm/mlx-vlm
> libraries, load the `mlx-models` skill.
